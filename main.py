    """
    Grammar Corrector Z8mejn
    ========================
    Developer-friendly AI library that helps you tag documents programmatically.
    ...
    APP_NAME    = "Grammar Corrector Z8mejn"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly AI library that helps you tag documents programmatically.")
